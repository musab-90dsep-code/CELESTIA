...
export const rooms: Room[] = [
  ...
  {
    id: 'vip',
    name: 'SAMAWET AL KHALEJ Presidential Residence',
    type: 'VIP Suite',
    price: 1850,
    ...
    description: 'The pinnacle of five-star hospitality. The SAMAWET AL KHALEJ Presidential Residence offers an unparalleled level of bespoke service, private elevators, and handcrafted boutique interiors.'
  }
];
...
export const galleryItems: GalleryItem[] = [
  { id: 1, title: 'SAMAWET AL KHALEJ Pool', category: 'Environment', image: 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?auto=format&fit=crop&w=800&q=80', description: 'Temperate-controlled luxury outdoor pool overlooking the city sunset skyline.' },
  ...
  { id: 4, title: 'SAMAWET AL KHALEJ Exterior Facade', category: 'Architecture', image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=800&q=80', description: 'The timeless visual icon that commands the city’s residential golden mile.' },
...
export const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    text: 'SAMAWET AL KHALEJ is not merely a hotel; it is an extension of home. The customized attention from our dedicated butler converted our three-month seasonal diplomatic stay into an unforgettable memory of comfort and serenity.',
  ...
  },
  {
    ...
    rating: 5,
    text: 'Having traveled to nearly 90 countries, I can confidently assert the executive suite at SAMAWET AL KHALEJ competes directly with the finest in Switzerland. The absolute anonymity, high-fidelity secure office, and spa were stellar.',
